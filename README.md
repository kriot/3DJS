...
In the end, we should multiplicate the vector for projection our matrix and normalize w (the last coordinate). We use 4x4 matrices only to be able to make this operation.
